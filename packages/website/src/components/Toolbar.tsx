...
export default function Toolbar(props: ToolbarProps): React.ReactElement {
  ...
  if (parser.homepage !== undefined && parser.homepage !== '') {
    parserInfo = (
      <a href={parser.homepage} target="_blank" rel="noopener noreferrer">
        {parserInfo}
      </a>
    );
  }
  if (showTransformer === true && transformer !== null && transformer !== undefined) {
    ...
    if (transformer.homepage !== undefined && transformer.homepage !== '') {
      transformerInfo = (
        <a href={transformer.homepage} target="_blank" rel="noopener noreferrer">
          {transformerInfo}
        </a>
      );
    }
  ...
  return (
    <div id="Toolbar">
      ...
      />
      <CategoryButton category={props.category} onCategoryChange={props.onCategoryChange} />
      <ParserButton
        parser={props.parser}
      ...
      />
      <KeyMapButton keyMap={props.keyMap} onKeyMapChange={props.onKeyMapChange} />
      <a
        style={{ minWidth: 0 }}
        target="_blank"
