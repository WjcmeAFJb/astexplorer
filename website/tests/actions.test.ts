...
describe('action creators', () => {
  ...
  test('all action type constants are unique strings', () => {
    const types = [
      actions.SET_ERROR,
      actions.CLEAR_ERROR,
      actions.LOAD_SNIPPET,
      actions.START_LOADING_SNIPPET,
      actions.DONE_LOADING_SNIPPET,
      actions.CLEAR_SNIPPET,
      actions.SELECT_CATEGORY,
      actions.SELECT_TRANSFORMER,
      actions.HIDE_TRANSFORMER,
      actions.SET_TRANSFORM,
      actions.SET_TRANSFORM_RESULT,
      actions.SET_PARSER,
      actions.SET_PARSER_SETTINGS,
      actions.SET_PARSE_RESULT,
      actions.SET_SNIPPET,
      actions.OPEN_SETTINGS_DIALOG,
      actions.CLOSE_SETTINGS_DIALOG,
      actions.EXPAND_SETTINGS_DRAWER,
      actions.COLLAPSE_SETTINGS_DRAWER,
      actions.OPEN_SHARE_DIALOG,
      actions.CLOSE_SHARE_DIALOG,
      actions.SET_CODE,
      actions.SET_CURSOR,
      actions.DROP_TEXT,
      actions.SAVE,
