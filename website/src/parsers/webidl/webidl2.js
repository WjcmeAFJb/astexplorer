...
export default {
  ...
  loadParser(/** @type {(realParser: WebIDL2Module) => void} */ callback) {
    require(['webidl2'], callback);
  },

  parse(/** @type {WebIDL2Module} */ { parse }, /** @type {string} */ code, /** @type {import('webidl2').ParseOptions} */ options) {
    return parse(code, options);
  },

  opensByDefault(/** @type {{members?: object[]}} */ node, /** @type {string} */ key) {
    return key === 'members';
  },
