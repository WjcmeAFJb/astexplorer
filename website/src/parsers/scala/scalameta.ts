...
export default {
  ...
  parse(/** @type {{parseSource: (code: string, options: Record<string, unknown>) => {error?: string, lineNumber?: number, columnNumber?: number}}} */ scalametaParser, code: string, options: Record<string, unknown>) {
