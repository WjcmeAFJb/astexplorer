...
export default {
   ...
   */
  opensByDefault(_node: Record<string, unknown>, _key: Record<string, unknown>) {
    return false;
  },
  ...
  *forEachProperty(node: Record<string, unknown>) {
   ...
   */
  renderSettings(settings: Record<string, unknown> | null, onChange: (settings: Record<string, unknown>) => void) {
