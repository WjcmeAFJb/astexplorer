...
export default {
  ...
  loadTransformer(/** @type {(realTransformer: {transpile: (code: string) => string, recast: typeof import('ember-template-recast')}) => void} */ callback) {
    require(
      ...
      (/** @type {{default: (code: string) => string}} */ transpile, /** @type {typeof import('ember-template-recast')} */ recast) => callback({ transpile: transpile.default, recast }),
    );
  },

  transform(/** @type {{transpile: (code: string) => string, recast: typeof import('ember-template-recast')}} */ { transpile, recast }, /** @type {string} */ transformCode, /** @type {string} */ code) {
