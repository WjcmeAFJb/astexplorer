...
export default {
  ...
  loadParser(/** @type {(realParser: ReworkParse) => void} */ callback) {
    require(['css/lib/parse'], (/** @type {ReworkParse} */ m) => callback(m));
  },
  ...
  opensByDefault(/** @type {ReworkNode} */ node, /** @type {string} */ key) {
    return key === 'rules';
  },
